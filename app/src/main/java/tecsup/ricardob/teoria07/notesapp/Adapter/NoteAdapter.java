package tecsup.ricardob.teoria07.notesapp.Adapter;
...
import tecsup.ricardob.teoria07.notesapp.Activity.DetailActivity;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(NoteAdapter.ViewHolder viewHolder, final int position) {
        ...
        /*
        Bitmap bmp = BitmapFactory.decodeByteArray(note.getPicture(), 0, note.getPicture().length);
        viewHolder.pictureImage.setImageBitmap(Bitmap.createScaledBitmap(bmp, viewHolder.pictureImage.getWidth(),
                viewHolder.pictureImage.getHeight(), false));*/
